...
class Activation(models.Model):
    user = models.OneToOneField(MyUser, related_name='user_act_code', on_delete=models.CASCADE)
    code = models.CharField(max_length=5, default=generate_activation_code, unique=True)
